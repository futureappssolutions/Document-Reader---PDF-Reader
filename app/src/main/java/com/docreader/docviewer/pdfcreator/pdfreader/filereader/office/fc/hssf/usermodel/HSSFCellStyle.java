...
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.ss.usermodel.IFont;
 ...
 * @see com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hssf.usermodel.HSSFCell#setCellStyle(HSSFCellStyle)
 */
public final class HSSFCellStyle implements ICellStyle {
     ...
     * @see com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hssf.usermodel.HSSFDataFormat
     */
     ...
     * @return the format string or "General" if not found
     */
    public String getDataFormatString(com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.ss.usermodel.Workbook workbook) {
     ...
     * @see com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hssf.usermodel.HSSFDataFormat
     */
    public String getDataFormatString(com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hssf.model.InternalWorkbook workbook)
    {
...
//        return format.getFormat(getDataFormat());
     ...
     * @see com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hssf.usermodel.HSSFWorkbook#createFont()
     * @see com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hssf.usermodel.HSSFWorkbook#getFontAt(short)
     */
     ...
     * @see com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hssf.usermodel.HSSFCellStyle#getFontIndex()
     * @see com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hssf.usermodel.HSSFWorkbook#getFontAt(short)
     */
    public HSSFFont getFont(com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.ss.usermodel.Workbook parentWorkbook) {
     ...
     * @see com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hssf.usermodel.HSSFPalette#getColor(short)
    ...
    private void checkDefaultBackgroundFills() {
      if (_format.getFillForeground() == com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hssf.util.HSSFColor.AUTOMATIC.index) {
    	  ...
    	  if (_format.getFillBackground() != (com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hssf.util.HSSFColor.AUTOMATIC.index+1))
    		  setFillBackgroundColor((short)(com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hssf.util.HSSFColor.AUTOMATIC.index+1));
      } else if (_format.getFillBackground() == com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hssf.util.HSSFColor.AUTOMATIC.index+1)
    	  //Now if the forground changes to a non-AUTOMATIC color the background resets itself!!!
    	  if (_format.getFillForeground() != com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hssf.util.HSSFColor.AUTOMATIC.index)
    		  setFillBackgroundColor(com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hssf.util.HSSFColor.AUTOMATIC.index);
    }
