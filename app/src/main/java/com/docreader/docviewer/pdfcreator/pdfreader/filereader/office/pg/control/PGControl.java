...
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.system.AbstractControl;
    ...
    public void actionEvent(int actionID, final Object obj)
    {
        switch (actionID)
        {
            ...
            case EventConstant.PG_NOTE_ID:                          //show notes
                ...
                vector.add(text);
                new com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.pg.dialog.NotesDialog(this, getMainFrame().getActivity(), null, vector,
...
//            safeAsyncTask.execute((Void)null);
     ...
     * 
     *(non-Javadoc)
     * @see com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.system.AbstractControl#getActivity()
     *
     */
