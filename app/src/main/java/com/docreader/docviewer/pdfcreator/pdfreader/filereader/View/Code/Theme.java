...
public class Theme {
    ...
    public static final Theme f811VS = new Theme("vs");
    ...
    static {
        Theme theme = ATELIER_DUNE_DARK;
        Theme theme2 = ATELIER_FOREST_DARK;
        ALL = Arrays.asList(AGATE, ANDROIDSTUDIO, ARDUINO_LIGHT, ARTA, ASCETIC, ATELIER_CAVE_DARK, ATELIER_CAVE_LIGHT, theme, ATELIER_DUNE_LIGHT, theme, ATELIER_ESTUARY_DARK, ATELIER_ESTUARY_LIGHT, theme2, theme2, ATELIER_FOREST_LIGHT, ATELIER_HEATH_DARK, ATELIER_HEATH_LIGHT, ATELIER_LAKESIDE_DARK, ATELIER_LAKESIDE_LIGHT, ATELIER_PLATEAU_DARK, ATELIER_PLATEAU_LIGHT, ATELIER_SAVANNA_DARK, ATELIER_SAVANNA_LIGHT, ATELIER_SEASIDE_LIGHT, ATELIER_SEASIDE_DARK, ATELIER_SULPHURPOOL_DARK, ATELIER_SULPHURPOOL_LIGHT, ATOM_ONE_DARK, ATOM_ONE_LIGHT, BROWN_PAPER, CODEPEN_EMBED, COLOR_BREWER, DARCULA, DARK, DARKULA, DEFAULT, DOCCO, DRACULA, FAR, FOUNDATION, GITHUB, GITHUB_GIST, GOOGLECODE, GRAYSCALE, GRUVBOX_DARK, GRUVBOX_LIGHT, HOPSCOTCH, HYBRID, IDEA, IR_BLACK, KIMBIE_DARK, KIMBIE_LIGHT, MAGULA, MONO_BLUE, MONOKAI, MONOKAI_SUBLIME, OBSIDIAN, OCEAN, PARAISO_DARK, PARAISO_LIGHT, POJOAQUE, PUREBASIC, QTCREATOR_DARK, QTCREATOR_LIGHT, RAILSCASTS, RAINBOW, SCHOOL_BOOK, SOLARIZED_DARK, SOLARIZED_LIGHT, SUNBURST, TOMORROW, TOMORROW_NIGHT, TOMORROW_NIGHT_BLUE, TOMORROW_NIGHT_BRIGHT, TOMORROW_NIGHT_EIGHTIES, f811VS, VS2015, XCODE, XT256, ZENBURN);
    }
