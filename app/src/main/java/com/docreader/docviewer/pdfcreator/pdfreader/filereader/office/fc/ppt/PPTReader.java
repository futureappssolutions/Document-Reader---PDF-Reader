 ...
 * 时间:               下午4:23:51
 */
package com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.ppt;
...
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.common.shape.ArbitraryPolygonShape;
...
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.common.shape.TableCell;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.common.shape.TableShape;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.common.shape.TextBox;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.constant.AutoShapeConstant;
...
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.HSLFSlideShow;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.Fill;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.HeadersFooters;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.Line;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.MasterSheet;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.Notes;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.Shape;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.ShapeGroup;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.Sheet;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.SimpleShape;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.Slide;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.SlideMaster;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.TextShape;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.TitleMaster;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.BinaryTagDataBlob;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.ClientVisualElementContainer;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.DocumentAtom;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.OEPlaceholderAtom;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.PositionDependentRecordContainer;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.Record;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.SlideAtom;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.SlideAtom.SSlideLayoutAtom;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.SlideProgBinaryTagContainer;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.SlideProgTagsContainer;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.SlideShowSlideInfoAtom;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.TimeAnimateBehaviorContainer;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.TimeBehaviorContainer;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.TimeColorBehaviorContainer;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.TimeCommandBehaviorContainer;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.TimeEffectBehaviorContainer;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.TimeMotionBehaviorContainer;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.TimeNodeAttributeContainer;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.TimeNodeContainer;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.TimeRotationBehaviorContainer;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.TimeScaleBehaviorContainer;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.TimeSetBehaviorContainer;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.TimeVariant;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.VisualShapeAtom;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.usermodel.PictureData;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.usermodel.RichTextRun;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.usermodel.SlideShow;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.ppt.bulletnumber.BulletNumberManage;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.java.awt.Dimension;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.java.awt.Rectangle;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.java.awt.Rectanglef;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.java.awt.geom.Rectangle2D;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.pg.animate.ShapeAnimation;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.pg.model.PGModel;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.pg.model.PGNotes;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.pg.model.PGSlide;
...
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.ss.util.format.NumericFormatter;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.system.AbstractReader;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.system.BackReaderThread;
...
{   
    ...
    private com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.common.borders.Line getShapeLine(SimpleShape shape)
    {
    	return getShapeLine(shape, false);
    }
    
    private com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.common.borders.Line getShapeLine(SimpleShape shape, boolean isTableCellLine)
    {
        com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.common.borders.Line line = null;
        if(shape != null && shape.hasLine())
        {
             ...
             com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.java.awt.Color color = ((SimpleShape)shape).getLineColor();
             
             if(color != null)
             {
            	 line = new com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.common.borders.Line();
    ...
    private BackgroundAndFill converFill(PGSlide pgSlide, Fill fill)
    {
        ...
        {        	
                    ...
                    || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.java.awt.Color fillColor = fill.getForegroundColor();
            	com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.java.awt.Color fillbackColor = fill.getFillbackColor();
    ...
    private void processNotes(PGSlide pgSlide, Notes notes)
    {
        if (notes != null)
        {
            ...
            for (Shape shape : notes.getShapes())
            {
                ...
                if(shape instanceof com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.AutoShape  // 文本框
                    || shape instanceof com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.TextBox)  // 占位符
                {
...
//        }
        ...
        if (shape instanceof Line
            || shape instanceof com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.Freeform
            || shape instanceof com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.AutoShape
            || shape instanceof com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.TextBox
            || shape instanceof com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.Picture)
        {  
            if (shape instanceof Line)
            {
                if (line != null)
            ...
            else if(shape instanceof com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.Freeform)
            {              
                if (fill != null || line != null)
                {
                    ...
                    if (startArrowType > 0)
                    {
                    	ArrowPathAndTail arrowPathAndTail = ((com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.Freeform)shape).getStartArrowPathAndTail(rect);
                    ...
                    if (endArrowType > 0)
                    {                        
                    	ArrowPathAndTail arrowPathAndTail = ((com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.Freeform)shape).getEndArrowPathAndTail(rect);
                    	if(arrowPathAndTail != null && arrowPathAndTail.getArrowPath() != null)
                        {
                    ...
                    Path[] paths = ((com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.Freeform)shape).getFreeformPath(rect,
            ...
            else if(shape instanceof com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.AutoShape
                    || shape instanceof com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.TextBox)
            {
                // autoShape
            ...
            // 图片
            else if(shape instanceof com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.Picture)
            {   
                com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.Picture poiPic = (com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.Picture)shape;
        ...
        else if(shape instanceof com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.Table)
        {
            com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.Table poiTable = (com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.Table)shape;
            if (poiTable != null)
            {
     ...
     * @param pgSlide
     */
    private void processTable(PGSlide pgSlide, com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.Table poiTable, GroupShape parent, int slideType)
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            for (int j = 0; j < columns; j++)
            {
                ...
                com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.TableCell poiCell = poiTable.getCell(i, j);
                if (poiCell != null)
                {
        ...
        {
        	com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.common.borders.Line aLine = getShapeLine(line, true);
            if (aLine != null)
            {
    ...
    private int getBorderColor(Line line)
    {
        if (line != null)
        {
            com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.java.awt.Color color = line.getLineColor();
            if (color != null)
            {
    ...
    private void processNormalTextShape(TextBox tb, TextShape ts, Rectangle rect, int slideType, int placeHolderID)
    {
        ...
        if (text != null && text.trim().length() > 0)
        {
            ...
            int len = text.length();
            com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.Hyperlink[] links = ts.getTextRun().getHyperlinks();
            int start = 0;
            // title type just a paragraph needs be processed specially
            if (ts.getTextRun().getRunType() != com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.TextHeaderAtom.TITLE_TYPE)
            {
                for (int i = 0; i < len; i++)
                {
                    if (abortReader)
    ...
    private void processParagraph(SectionElement secElem, TextShape ts, String text,
        com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.model.Hyperlink[] links, int start, int end, int placeHolderID)
    {
        ...
        com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.hslf.record.TextRulerAtom ruler = ts.getTextRun().getTextRuler();
        if (ruler != null)
        {
...
//      }
     ...
     * 
     */
    private int converterColor(com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.java.awt.Color color)
    {
//        if(color.getAlpha() == 0)
//        {
