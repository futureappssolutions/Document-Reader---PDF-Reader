...
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.thirdpart.emf.data.BitmapInfoHeader;
import com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.thirdpart.emf.data.BlendFunction;
...
public class EMFImageLoader {
    ...
    public static Bitmap readImage(
        ...
        if (bmi.getBitCount() == 1) {
            ...
            f.setSize(new com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.java.awt.Dimension(width + 20, height + 20));
            f.setVisible(true);*/
