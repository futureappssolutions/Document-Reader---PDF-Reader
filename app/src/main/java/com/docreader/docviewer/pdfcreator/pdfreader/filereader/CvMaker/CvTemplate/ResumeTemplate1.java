...
public class ResumeTemplate1 {
    ...
    public String getProfilePic(Context context) {
        ...
        Uri parse = Uri.parse(sharedPrefs.getProfilePic());
        Utility.logCatMsg("uri " + parse.toString());
        String convertToBase64String = Utility.convertToBase64String(context, parse);
