...
public class ResumeTemplate7 {
    ...
    public String getEducation() {
        ...
        for (int i = 0; i < resume.schools.size(); i++) {
            if (resume.schools.get(i).getFromDate() == null) {
                resume.schools.get(i).setFromDate("2010");
            }
            if (resume.schools.get(i).getToDate() == null) {
                resume.schools.get(i).setToDate("2014");
            }
