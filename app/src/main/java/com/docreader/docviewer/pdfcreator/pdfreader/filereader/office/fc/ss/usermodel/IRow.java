...
public interface IRow extends Iterable<ICell> {
     ...
     * @see #getCell(int, com.com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.ss.usermodel.IRow.MissingCellPolicy)
     */
    ICell getCell(int cellnum);
    
    /**
     * Returns the cell at the given (0 based) index, with the specified {@link com.com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.fc.ss.usermodel.IRow.MissingCellPolicy}
     *
