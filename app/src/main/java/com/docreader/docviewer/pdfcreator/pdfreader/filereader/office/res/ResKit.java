...
package com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.res;
...
public class ResKit
{
    ...
    public ResKit()
    {
        try
        {
            ...
            // load "ResConstant"
            Class cls = Class.forName("com.docreader.docviewer.pdfcreator.pdfreader.filereader.office.res.ResConstant");
            // get all fields
